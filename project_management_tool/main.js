                ...
                for(var j=0; j<items.length; j++){
                    if(items[j]==";"){
                        if(semi1==-1){
                            ...
                            content+="<div style='display:block'><label><input type='checkbox' class='checkbox' onclick='toggleChecked(this,"+num+","+taskCount+","+itemCount+")'";
                            var checked=localStorage.getItem("cp"+num + "t" +taskCount);
                            if(checked[itemCount-1] == ";"){
                                content+=" checked";
                            }

                            content+="></input><div></div> <input type='text' id='t" + taskCount + ";" + itemCount + "'onchange='changeItem(" +num + "," +taskCount + "," + itemCount + ")' value='" + inners + "'></input></label></div>"
                            semi1 = semi2;
                        }
                    }
                }
                ...
                if(firstSemi==-1){
                    ...
                    if(taskCount== taskNum){
                       ...
                       if(passed){
                        ...
                        localStorage.removeItem("p"+projectNum+"t"+nextTask);
...
function changeItem(projectNum,taskNum,itemNum){
    ...
    var items=localStorage.getItem("o"+projectNum+"t"+taskNum);
    var before = "";
    var after = "";
    var itemCount=0;
    var firstSemi=-1;
